export const CASE_STUDIES_LIST = [
  {
    ...
    region: 'Pakistan', flag: '🇵🇰', status: 'live',
    company: 'FMCG Distribution Company',
    industry: 'FMCG / Ice Cream Distribution',
    tag: 'Video Monitoring', color: '#E8312A',
    result: '30–40%', resultLabel: 'Operational Improvement',
    metric: '700+ Devices',
    ...
    challenge: 'The company had no reliable system to monitor driver behavior across its ice cream distribution fleet. There was no visibility into what drivers were doing on the road — whether drowsy driving was occurring, smoking during duty hours, or harsh driving violations were taking place.',
    features: [
  ...
  },
  {
    ...
    tag: 'Temperature Monitoring', color: '#0284c7',
    result: '0', resultLabel: 'Cold Chain Breaches',
    metric: '500+ Monitored Vehicles',
    desc: 'Real-time temperature monitoring solution deployed across an ice cream distribution fleet — ensuring product integrity from warehouse to end customer.',
    ...
    challenge: 'Ice cream and frozen products are highly sensitive to temperature fluctuations. Without monitoring, temperature deviations during transport went undetected — resulting in spoiled products, customer complaints, financial losses, and damaged brand reputation.',
    features: [
  ...
  },
  {
    ...
    tag: 'Supply Chain Monitoring', color: '#7c3aed',
    result: '45%', resultLabel: 'Faster Delivery Cycles',
    ...
    overview: 'Timeline Telematics deployed a comprehensive supply chain monitoring solution for a national logistics provider in Pakistan. The solution combined fleet tracking with personal/personnel tracking.',
    challenge: 'Managing a large-scale supply chain operation across Pakistan meant dealing with blind spots at every level. Vehicles were untracked, field personnel had no check-in system, dispatchers had no real-time visibility.',
    features: [
  ...
  {
    id: 'me-rta',
    region: 'Middle East', flag: '🇦🇪', status: 'live',
    company: 'Roads & Transport Authority',
    industry: 'Government / Road Transport',
    tag: 'Road Transport Tracking', color: '#0369a1',
    result: '99.8%', resultLabel: 'Fleet Compliance Rate',
    ...
    overview: 'Timeline Telematics partnered with a Roads & Transport Authority in the Middle East to deploy a city-wide road transport tracking and management platform.',
    challenge: 'Managing public road transport across a fast-growing city requires precise coordination, strict compliance monitoring, and real-time incident response.',
    features: [
  ...
  },
  {
    ...
    tag: 'School Bus Tracking', color: '#d97706',
    result: '100%', resultLabel: 'Student Safety Compliance',
    ...
    overview: 'Timeline Telematics deployed a comprehensive school bus tracking solution for a school transport operator in Qatar. The system provided real-time visibility for school administrators, enabled parent notifications, and ensured driver behavior compliance.',
    challenge: 'School bus operators face unique responsibilities — the safety of children is non-negotiable. Without a tracking system, schools had no way to verify bus locations, parents had no visibility into arrival times.',
    features: [
...
export const getCaseStudyById = (id) => CASE_STUDIES_LIST.find(cs => cs.id === id) || null;
export const getLiveCaseStudies = () => CASE_STUDIES_LIST.filter(cs => cs.status === 'live');
