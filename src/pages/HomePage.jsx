...
const TICKER_ITEMS = [
  '25,000+ Active Fleets',
  'GPS Fleet Management',
  'Pakistan · UAE · Europe',
  '99.9% Uptime SLA',
  '30% Fuel Cost Reduction',
  'Founded 2012 · Karachi',
...
const STATS = [
  {
    ...
    hint: 'Established in Karachi, 2012',
  },
  {
    body: '25K',
    accent: '+',
    name: 'Active Fleet Operators',
    hint: 'Globally managed, 3 continents',
  },
  {
    body: '50M',
    accent: '+',
      ...
      >
        ...
        <Reveal direction="right" delay={0.12}>
          ...
          >
            ...
            industry in Pakistan was still operating on paper logs and phone calls.
          ...
          >
            Today, with 25,000+ fleets trusting us globally and teams across
            Pakistan, UAE, and Europe, I'm proud of what we've built. But this is
...
const TIMELINE = [
  {
    ...
    label: 'Founded',
    title: 'The Beginning',
    desc: 'Timeline Telematics was founded in Karachi. First 12 vehicles tracked. Platform built from scratch by our local engineering team with a single conviction: every Pakistani fleet operator deserves enterprise-grade GPS tracking.',
  },
  {
    year: '2015',
    label: 'Milestone',
  ...
  },
  {
    ...
    desc: 'Dubai office opened. Arabic language support and UAE RTA integration launched. Hardware certified for Gulf heat extremes. First enterprise contracts with major Gulf logistics operators.',
  },
  {
    year: '2021',
    label: 'Europe',
    title: 'European Market Entry',
    desc: 'Frankfurt office established. EU tachograph compliance, Working Time Directive, and full GDPR infrastructure built. Now serving cross-border logistics operators across 12 European countries.',
  },
  {
    year: '2023',
    label: 'Scale',
    title: '25,000+ Fleets Milestone',
    desc: '25,000+ active fleet operators globally. 50M+ daily data points. Forbes Middle East recognition. Three continental offices fully operational with local language support.',
  },
  {
    year: '2024',
    label: 'AI Era',
